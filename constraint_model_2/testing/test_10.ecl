...
maximize(RowFile, FreqFile, Rows) :-
	...
	Freq1 :: [0, 20, 30, 40, 50, 70, 90, 10],
	Freq2 :: [0, 40, 50, 70, 90, 10, 20, 30],
	Freq3 :: [0, 70, 90, 10, 20, 30, 40, 50],
	Freq4 :: [0, 10, 20, 30, 40, 50, 70],
	Freq5 :: [0, 30, 40, 50, 70, 90],
	Freq6 :: [0, 50, 70, 90, 10],
	Freq7 :: [0, 90, 10, 20],
	Freq8 :: [0, 10, 20],
	Freq9 :: [0, 30],
	...
	((Row1 #= 2 and Freq1 #= 20) or
	 (Row1 #= 3 and Freq1 #= 30) or
	 (Row1 #= 4 and Freq1 #= 40) or
	 (Row1 #= 5 and Freq1 #= 50) or
	 (Row1 #= 6 and Freq1 #= 70) or
	 (Row1 #= 7 and Freq1 #= 90) or
	 (Row1 #= 8 and Freq1 #= 10) or
	 (Row1 #= 9 and Freq1 #= 20) or
	 (Row1 #= 10 and Freq1 #= 30) or
	 (Row1 #= 0 and Freq1 #= 0)), 

	((Row2 #= 3 and Freq2 #= 40) or
	 (Row2 #= 4 and Freq2 #= 50) or
	 (Row2 #= 5 and Freq2 #= 70) or
	 (Row2 #= 6 and Freq2 #= 90) or
	 (Row2 #= 7 and Freq2 #= 10) or
	 (Row2 #= 8 and Freq2 #= 20) or
	 (Row2 #= 9 and Freq2 #= 30) or
	 (Row2 #= 10 and Freq2 #= 40) or
	 (Row2 #= 0 and Freq2 #= 0)), 

	((Row3 #= 4 and Freq3 #= 70) or
	 (Row3 #= 5 and Freq3 #= 90) or
	 (Row3 #= 6 and Freq3 #= 10) or
	 (Row3 #= 7 and Freq3 #= 20) or
	 (Row3 #= 8 and Freq3 #= 30) or
	 (Row3 #= 9 and Freq3 #= 40) or
	 (Row3 #= 10 and Freq3 #= 50) or
	 (Row3 #= 0 and Freq3 #= 0)), 

	((Row4 #= 5 and Freq4 #= 10) or
	 (Row4 #= 6 and Freq4 #= 20) or
	 (Row4 #= 7 and Freq4 #= 30) or
	 (Row4 #= 8 and Freq4 #= 40) or
	 (Row4 #= 9 and Freq4 #= 50) or
	 (Row4 #= 10 and Freq4 #= 70) or
	 (Row4 #= 0 and Freq4 #= 0)), 

	((Row5 #= 6 and Freq5 #= 30) or
	 (Row5 #= 7 and Freq5 #= 40) or
	 (Row5 #= 8 and Freq5 #= 50) or
	 (Row5 #= 9 and Freq5 #= 70) or
	 (Row5 #= 10 and Freq5 #= 90) or
	 (Row5 #= 0 and Freq5 #= 0)), 

	((Row6 #= 7 and Freq6 #= 50) or
	 (Row6 #= 8 and Freq6 #= 70) or
	 (Row6 #= 9 and Freq6 #= 90) or
	 (Row6 #= 10 and Freq6 #= 10) or
	 (Row6 #= 0 and Freq6 #= 0)), 

	((Row7 #= 8 and Freq7 #= 90) or
	 (Row7 #= 9 and Freq7 #= 10) or
	 (Row7 #= 10 and Freq7 #= 20) or
	 (Row7 #= 0 and Freq7 #= 0)), 

	((Row8 #= 9 and Freq8 #= 10) or
	 (Row8 #= 10 and Freq8 #= 20) or
	 (Row8 #= 0 and Freq8 #= 0)), 

	((Row9 #= 10 and Freq9 #= 30) or
	 (Row9 #= 0 and Freq9 #= 0)), 
